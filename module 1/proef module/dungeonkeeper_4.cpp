...
int main() {
    ...
    cout << "Een verkoper sluipt naar binnen\n" << endl;
    ...
    cout << "Je gaat verder en je ziet nog een deur. Je doet het open." << endl;
    cout << "" << endl;
    ...
    cout << "Kies je zwaard (1) of kies je schild (2)? Kies uit 1 en 2: " << endl;
    unsigned short int picked_item; cin >> picked_item;
    
    string item;
    if (picked_item == 1) {item = "zwaard"; player1.setAttack(player1.getAttack() + 2);}
    if (picked_item == 2) {item = "schild"; player1.setDefense(player1.getDefense() + 1);}
    cout << "Je pakt het " << item << " op en houd het bij je. Je hebt een rupee besteden. RUPEE -1" << endl;
    player1.setRupees(player1.getRupees() - 1);
